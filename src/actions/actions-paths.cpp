...
std::vector<std::vector<Glib::ustring>> raw_data_path =
{
    ...
    {"app.path-break-apart",         N_("Break Apart"),          "Path",   N_("Break selected paths, creating new independent paths from the subpaths")},
    ...
    {"win.path-offset",              N_("Outset"),               "Path",   N_("Outset selected paths")},
