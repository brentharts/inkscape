...
{
public:
    ConnectorObjectKnotHolder(SPDesktop *desktop, SPItem *item, SPKnotHolderReleasedFunc relhandler);
    ~ConnectorObjectKnotHolder() override = default;
};
...
{
public:
    ConnectorLineKnotHolder(SPDesktop *desktop, SPItem *item, SPKnotHolderReleasedFunc relhandler);
...
{
public:
    ConnectorKnotCheckpoint(int index, int dir, int dynamic);
    Geom::Point knot_get() const override;
    void knot_set(Geom::Point const &p, Geom::Point const &origin, unsigned int state) override;
    void knot_ungrabbed(Geom::Point const &p, Geom::Point const &origin, guint state) override{};
    void knot_click(guint state) override;
...
{
public:
    ConnectorPointsKnotHolder(SPDesktop *desktop, SPItem *item, SPKnotHolderReleasedFunc relhandler);
    ~ConnectorPointsKnotHolder() override = default;
};
...
public:
    Geom::Point knot_get() const override;
    void knot_enter(unsigned int state) override;
};
