...
static void dialogLoggingCallback(char const * /*log_domain*/, GLogLevelFlags /*log_level*/,
                                  char const *const messageText, gpointer user_data)
{
...
void Messages::captureLogMessages()
{
    ...
    */
    GLogLevelFlags flags = (GLogLevelFlags)(G_LOG_LEVEL_ERROR | G_LOG_LEVEL_CRITICAL | G_LOG_LEVEL_WARNING |
