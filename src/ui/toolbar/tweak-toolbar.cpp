        ...
        : Toolbar(desktop)
{
    ...
    /* Width */
    {
        ...
        _width_item->set_focus_widget(desktop->get_active_canvas());
    ...
    // Force
    {
        ...
        _force_item->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Fidelity */
    {
        ...
        _fidelity_item->set_focus_widget(desktop->get_active_canvas());
