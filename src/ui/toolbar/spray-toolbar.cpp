    ...
    Toolbar(desktop)
{
    ...
    {   /* Population */
        ...
        _spray_population->set_focus_widget(desktop->get_active_canvas());
    ...
    {   /* Rotation */
        ...
        _spray_rotation->set_focus_widget(desktop->get_active_canvas());
    ...
    {   /* Scale */
        ...
        _spray_scale->set_focus_widget(desktop->get_active_canvas());
...

    {
        ...
        sd_item->set_focus_widget(desktop->get_active_canvas());
...

    {
        ...
        mean_item->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Offset */
    {
        ...
        _offset->set_focus_widget(desktop->get_active_canvas());
