    ...
    _freeze(false)
{
    ...
    /* Width */
    {
        ...
        _width->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Thinning */
    {
        ...
        _thinning->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Cap Rounding */
    {
        ...
        _cap_rounding->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Tremor */
    {
        ...
        _tremor->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Mass */
    {
        ...
        _mass->set_focus_widget(desktop->get_active_canvas());
