    ...
    , _mode_item(Gtk::make_managed<UI::Widget::LabelToolItem>(_("<b>New:</b>")))
{
    ...
    /* Magnitude */
    {
        ...
        _magnitude_item->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Spoke ratio */
    {
        ...
        _spoke_item->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Roundedness */
    {
        ...
        _roundedness_item->set_focus_widget(desktop->get_active_canvas());
    ...
    /* Randomization */
    {
        ...
        _randomization_item->set_focus_widget(desktop->get_active_canvas());
