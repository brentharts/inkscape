...
void InkscapePreferences::initPageBehavior()
{
    ...
    _lpe_copy_mirroricons.init ( _("Use advanced mirroring options"), "/live_effects/copy/mirroricons", true); // text label
    _page_lpe.add_line( true, "", _lpe_copy_mirroricons, "",
                           _("Enables using advanced mirror options between the copies (so there can be copies that are mirrored differently between the rows and the columns).")); // tooltip
