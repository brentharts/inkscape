...
private: // Signal handlers
    ...
    static int fuzzy_points_compair(int fuzzy_points_count_1, int fuzzy_points_count_2, int text_len_1, int text_len_2);
     ...
     */
    static void add_color(Gtk::Label *label, const Glib::ustring &search, const Glib::ustring &subject,bool tooltip=false);
    static void remove_color(Gtk::Label *label, const Glib::ustring &subject,bool tooltip=false);
