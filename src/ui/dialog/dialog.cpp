      ...
      _behavior(nullptr)
{
    ...
    _connections.emplace_back(SP_ACTIVE_DESKTOP->signal_dialogs_hide.connect(sigc::mem_fun(*this, &Dialog::onHideF12)));
    _connections.emplace_back(SP_ACTIVE_DESKTOP->signal_dialogs_unhide.connect(sigc::mem_fun(*this, &Dialog::onShowF12)));
