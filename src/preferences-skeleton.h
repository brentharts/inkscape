...
<inkscape version="1"
  ...
  <group id="tools" bounding_box="0">
    ...
    <group id="shapes" style="fill-rule:evenodd;" selcue="1" gradientdrag="1">
      ...
      <eventcontext id="spiral" style="fill:none;stroke:black" expansion="1" usecurrent="1"/>
    </group>
    ...
    <eventcontext id="eraser" mode="1" style="fill:#ff0000;fill-opacity:1;fill-rule:nonzero;stroke:none;"
                       mass="3.00" drag="1" angle="30" width="10" thinning="0.1" flatness="0.0" cap_rounding="1.4" usecurrent="1"
