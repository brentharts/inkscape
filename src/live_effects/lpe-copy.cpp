        ...
        if ((*it)->widget_is_visible) {
            ...
            if (widg) {
                    ...
                    param->param_key == "random_gap_y")
                {
                    ...
                    both->set_tooltip_markup(_("Blend scale in <b>diagonally</b> (top left clone is original scale, bottom right is new scale)"));
                    ...
                    both->set_tooltip_markup(_("Blend rotation in <b>diagonally</b> (top left clone is original rotation, bottom right is new rotation)"));
