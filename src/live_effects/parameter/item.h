...
public:
    ...
    ItemParam(ItemParam const &) = delete;
    ItemParam &operator=(ItemParam const &) = delete;
...
protected:
    char *href;     // contains link to other object, e.g. "#path2428", NULL if ItemParam contains pathdata itself
    ItemReference ref;
