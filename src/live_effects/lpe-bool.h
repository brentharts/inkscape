...
public:
    ...
    void doOnCopy(SPLPEItem const *lpeitem, Inkscape::ObjectSet *set) override;
    void doOnCut(SPLPEItem const *lpeitem) override;
    void doOnStamp(SPLPEItem const *lpeitem) override;
    void doOnPaste(SPLPEItem const *lpeitem) override;
    void doOnFork(LivePathEffect::Effect const *forkedeffect) override;
