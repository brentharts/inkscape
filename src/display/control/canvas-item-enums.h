...
enum CanvasItemCtrlType {
    ...
    CANVAS_ITEM_CTRL_TYPE_CONNECT_ITEM,
    CANVAS_ITEM_CTRL_TYPE_CONNECT_POINT,
    CANVAS_ITEM_CTRL_TYPE_CONNECT_HINT,
    CANVAS_ITEM_CTRL_TYPE_CONNECT_CHECKPOINT,
    CANVAS_ITEM_CTRL_TYPE_CONNECT_MIDPOINT,
    CANVAS_ITEM_CTRL_TYPE_CONNECTION,
