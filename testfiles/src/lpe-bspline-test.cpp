...
class LPEBSplineTest : public LPESTest {};
...
<svg
  ...
  <path
   ...
   pathCompare(d01, lpeitem01->getAttribute("d"),1);
   pathCompare(d02, lpeitem02->getAttribute("d"),1);
   pathCompare(d03, lpeitem03->getAttribute("d"),1);
   pathCompare(d04, lpeitem04->getAttribute("d"),1);
}


// INKSCAPE 1.0.2

TEST_F(LPEBSplineTest, bspline_MM_1_02)
{
   std::string svg = R""""(<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   xmlns:svg="http://www.w3.org/2000/svg"
...
TEST_F(LPEBSplineTest, bspline_PX_1_02)
{
   std::string svg = R""""(<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
