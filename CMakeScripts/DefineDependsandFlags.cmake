...
if(NOT WITH_INTERNAL_2GEOM)
    ...
    if(2Geom_FOUND)
        ...
        message(STATUS "lib2geom not found, using internal copy in src/3rdparty/inkscape_lib2geom")
    endif()
endif()
if(WITH_INTERNAL_2GEOM)
  set(2Geom_INCLUDE_DIRS ${CMAKE_SOURCE_DIR}/src/3rdparty/inkscape_lib2geom/include)
endif()
