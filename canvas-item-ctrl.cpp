...
guint32 CanvasItemCtrl::toRGBA32( int alpha ) 
{
...
/*void CanvasItemCtrl::something(guint32 rgba)
  {
    //this snippet is taken from pen_tool.cpp line#1277
